...
public class ReadRole {
    ...
    public ReadRoleOut readByRoleName(ReadByRoleNameIn readByRoleNameIn, RoleRepository roleRepository) throws EntityException, RoleNotFoundException, ValueObjectException {
